...
CREATE OR REPLACE FUNCTION "public"."prevent_duplicate_prescription_remarks"() RETURNS "trigger"
    ...
    AS $$
BEGIN
    -- Only check for duplicates on INSERT, not on UPDATE
...
CREATE OR REPLACE FUNCTION "public"."upsert_prescription_remarks"("p_prescription_id" "uuid", "p_for_constant_use" boolean DEFAULT false, "p_for_distance_vision_only" boolean DEFAULT false, "p_for_near_vision_only" boolean DEFAULT false, "p_separate_glasses" boolean DEFAULT false, "p_bi_focal_lenses" boolean DEFAULT false, "p_progressive_lenses" boolean DEFAULT false, "p_anti_reflection_lenses" boolean DEFAULT false, "p_anti_radiation_lenses" boolean DEFAULT false, "p_under_corrected" boolean DEFAULT false) RETURNS SETOF "public"."prescription_remarks"
...
ALTER TABLE ONLY "public"."contact_lens_eyes"
    ADD CONSTRAINT "contact_lens_eyes_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."contact_lens_items"
    ADD CONSTRAINT "contact_lens_items_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."contact_lens_payments"
    ADD CONSTRAINT "contact_lens_payments_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."contact_lens_prescriptions"
    ADD CONSTRAINT "contact_lens_prescriptions_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."prescription_remarks"
    ADD CONSTRAINT "prescription_remarks_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."prescriptions"
    ADD CONSTRAINT "unique_prescription_no" UNIQUE ("prescription_no");



ALTER TABLE ONLY "public"."contact_lens_eyes"
    ADD CONSTRAINT "uq_contact_lens_eye_side" UNIQUE ("contact_lens_prescription_id", "eye_side");



ALTER TABLE ONLY "public"."contact_lens_payments"
    ADD CONSTRAINT "uq_contact_lens_payment_prescription_id" UNIQUE ("contact_lens_prescription_id");



ALTER TABLE ONLY "public"."contact_lens_prescriptions"
    ADD CONSTRAINT "uq_contact_lens_prescription_id" UNIQUE ("prescription_id");



ALTER TABLE ONLY "public"."order_payments"
    ADD CONSTRAINT "uq_order_payment_order_id" UNIQUE ("order_id");



ALTER TABLE ONLY "public"."prescription_remarks"
    ADD CONSTRAINT "uq_prescription_remarks_prescription_id" UNIQUE ("prescription_id");
...
CREATE UNIQUE INDEX "idx_unique_mobile_no" ON "public"."prescriptions" USING "btree" ("mobile_no") WHERE (("mobile_no" IS NOT NULL) AND ("mobile_no" <> ''::"text"));
...
ALTER TABLE ONLY "public"."contact_lens_eyes"
    ADD CONSTRAINT "fk_contact_lens_eye" FOREIGN KEY ("contact_lens_prescription_id") REFERENCES "public"."contact_lens_prescriptions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."contact_lens_items"
    ADD CONSTRAINT "fk_contact_lens_item" FOREIGN KEY ("contact_lens_prescription_id") REFERENCES "public"."contact_lens_prescriptions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."contact_lens_payments"
    ADD CONSTRAINT "fk_contact_lens_payment" FOREIGN KEY ("contact_lens_prescription_id") REFERENCES "public"."contact_lens_prescriptions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."contact_lens_prescriptions"
    ADD CONSTRAINT "fk_contact_lens_prescription" FOREIGN KEY ("prescription_id") REFERENCES "public"."prescriptions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."eye_prescriptions"
    ADD CONSTRAINT "fk_eye_prescription" FOREIGN KEY ("prescription_id") REFERENCES "public"."prescriptions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."order_items"
    ADD CONSTRAINT "fk_order_item" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."order_payments"
    ADD CONSTRAINT "fk_order_payment" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."orders"
    ADD CONSTRAINT "fk_order_prescription" FOREIGN KEY ("prescription_id") REFERENCES "public"."prescriptions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."prescription_remarks"
    ADD CONSTRAINT "fk_prescription_remark" FOREIGN KEY ("prescription_id") REFERENCES "public"."prescriptions"("id") ON DELETE CASCADE;
